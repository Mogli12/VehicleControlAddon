...
function vehicleControlAddonRegister:postLoadMission(mission)
	...
	if g_client ~= nil then 
		...
		g_vehicleControlAddonTabbedFrame7 = VehicleControlAddonFrame7:new(g_vehicleControlAddonTabbedMenu,self.i18n)
		...
		g_gui:loadGui(Utils.getFilename("gui/vehicleControlAddonFrame7.xml", self.vcaDirectory), "vehicleControlAddonFrame7", g_vehicleControlAddonTabbedFrame7, true)
